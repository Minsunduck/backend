...
CORS(app, resources={r"/chat": {"origins": ["http://localhost:5000", "http://localhost:3000", "http://localhost:5173","https://frontend-eta-three-10.vercel.app","https://frontend-movie-theta.vercel.app"]}})
